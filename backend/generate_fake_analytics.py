"""
Generate realistic fake CCTV analytics data per Chicago neighborhood.

Produces data/processed/cctv/fake_analytics.json with per-neighborhood
CCTVData (cameras) and CCTVTimeseries (24h hourly buckets) that match
the shapes consumed by the frontend.

Usage:
    python backend/generate_fake_analytics.py
"""
...
def main():
    ...
    out_path = out_dir / "fake_analytics.json"
